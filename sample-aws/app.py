...
# VPC stack removed: AgentCore Runtime is AWS-managed, Lambda runs outside VPC.
# Gateway stack (Phase 4 ECS for WeChat/Feishu) removed: not needed for ChatWork.
# --------------------------------------------------------------------------
...
# Phase 4 ECS gateway removed (requires VPC; ChatWork uses webhook only).
